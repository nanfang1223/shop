<script>
     ...
     * 根路径
     */
	   // const LKT_ROOT_URL = 'https://jcsp.hzjcwlkj.cn'
	     const LKT_ROOT_URL ='https://app.hygapp.com'
    ...
    function laiketuiNoDoublePress (frompage, callback, opts) {
		...
		console.log(me.clicktimes,"me.clicktimes")
