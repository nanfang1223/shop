    ...
    <div>
            ...
            <view class="center_top">
                ...
                <view class="card">
                    ...
                    <view class="card_bottom">
                        <view style="background: #FF612A;" @tap="navTo('/pagesA/distribution/distribution_list')">{{language.distribution_center.agentShop}}</view>
                        <view style="background: #FF612A;" @tap="supply()">{{language.distribution_center.withdrawal}}</view>
                    </view>
        ...
        <div v-else-if="is_distribution == 0">
            <view class="noSupply">
                ...
                <view class="beproxy" style="background: #FF612A;" @tap="_navigator('./distribution_list')">{{language.distribution_center.upDistribution}}</view>
            </view>
        </div>
    ...
    methods: {
        ...
        supply() {
            if (this.tixian_id > 0) {
                ...
                uni.navigateTo({
                    url: './distribution_form?total='+this.order.comm2
                });
            }
        },
        /**
