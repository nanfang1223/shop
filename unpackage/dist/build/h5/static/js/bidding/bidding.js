...
export function lkt_showShareMask (me) {
    ...
    clipboard.on('success', function (e) {
        uni.showToast({
            title: me.language.toasts.bidding.copyOk,
            duration: 1000,
            icon: 'none'
        })
    })
    ...
    clipboard.on('error', function (e) {
        uni.showToast({
            title: me.language.toasts.bidding.copyFail,
            duration: 1000,
            icon: 'none'
        })
                ...
                success: (res) => {
                    ...
                    if (res.statusCode !== 200) {
                        ...
                        uni.showModal({
                            ...
                            content: me.language.showModal.payFail1,
                        ...
                        uni.requestPayment({
                            ...
                            success: (res) => {
                                ...
                                uni.showToast({
                                    title: me.language.toasts.bidding.payOk,
                                    duration: 1000,
                                    icon: 'none'
                                })
                                setTimeout(function () {
...
export async function lkt_pay_wx (type, me) {
    ...
    my.tradePay({
        ...
        success: function (res) {
            ...
            me.pay_display = false
            uni.showToast({
                title: me.language.toasts.bidding.yjOk,
                duration: 1000,
                icon: 'none'
            })
            uni.redirectTo({
...
export function lkt_payFail (me) {
    ...
    uni.showModal({
        ...
        success: function (res) {
            me.firstFlag = true
            // #ifdef H5
            var url = uni.getStorageSync('h5_url') + 'pagesA/bidding/bidding'
            if (res.cancel) {
...
export function lkt_click (me) {
    ...
    //去出价
        ...
        if (bid_value == '' || bid_value < money_s) {
            uni.showToast({
                title: me.language.toasts.bidding.moneyOk,
                duration: 1000,
                icon: 'none'
            })
        } else {
            ...
            uni.request({
                ...
                success: function (res) {
                    if (res.data.info == '更新加价成功！') {
                        ...
                        uni.showToast({
                            title: me.language.toasts.bidding.bidFailed,
                            duration: 1000,
                            icon: 'none'
                        })
                    }
